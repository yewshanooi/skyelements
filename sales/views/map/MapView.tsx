...
import { geocodeAddress, searchLocations, type LocationSuggestion } from '@/sales/services/geocodeService';
import { normalizeCoordinates, extractEmbeddedCoordinates } from '@/sales/lib/locationParser';
