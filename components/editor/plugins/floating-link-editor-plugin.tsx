  ...
  return (
    ...
    >
      {!isLink ? null : isLinkEditMode ? (
        ...
        <div className="flex items-center justify-between rounded-md border p-1 pl-5">
          <a
            href={sanitizeUrl(linkUrl)}
            target="_blank"
            rel="noopener noreferrer"
            className="cursor-pointer overflow-hidden text-sm text-ellipsis whitespace-nowrap"
          >
            {linkUrl}
          </a>
